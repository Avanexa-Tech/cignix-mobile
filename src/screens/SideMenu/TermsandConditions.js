        ...
        <View style={{width: '100%', alignItems: 'center'}}>
          ...
          <View style={{width: '100%'}}>
            ...
            <Text
              ...
              {t("TermsandConditions.Subject to your compliance with these Legal Terms, including the'PROHIBITED ACTIVITIES' section below, we grant you a non-exclusive, non-transferable, revocable license to")}: {t("access the Services; and download or print a copy of any portion of the Content to which you have properly gained access, solely for your personal, non-commercial use.")}
            </Text>
            <Text
              style={{
                textAlign: 'justify',
