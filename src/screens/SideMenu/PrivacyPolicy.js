            ...
            return (
                <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ width: '100%', marginTop: 10 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>{t("PrivacyPolicy.SUMMARY OF KEY POINTS")}</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Do we process any sensitive personal information?")} </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.What personal information do we process?")} </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 0 }}>{t("PrivacyPolicy.Do we collect any information from third parties?")} </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.How do we process your information?")} </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 0 }}>{t("PrivacyPolicy.In what situations and with which parties do we share personal information?")} </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.How do we keep your information safe?")}</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 0 }}>{t("PrivacyPolicy.What are your rights?")} </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.How do you exercise your rights?")}  </Text>
                    ...
                    <View style={{ width: '100%', marginTop: 20 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 0 }}>1. {t("PrivacyPolicy.WHAT INFORMATION DO WE COLLECT?")}</Text>

                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Personal information you disclose to us")} </Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, }}>{t("PrivacyPolicy.In Short")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 0, marginTop: 0 }}>{t("PrivacyPolicy.Personal Information Provided by You")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Sensitive Information")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Payment Data")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Information automatically collected")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, }}>{t("PrivacyPolicy.In Short")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.The information we collect includes")}:</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, }}>{t("PrivacyPolicy.Log and Usage Data")}: </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 0, marginTop: 0 }}>{t("PrivacyPolicy.Location Data")}: </Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Google API")}:  </Text>
                    ...
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 0 }}>2. {t("PrivacyPolicy.HOW DO WE PROCESS YOUR INFORMATION?")}</Text>

                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.In Short")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To facilitate account creation and authentication and otherwise manage user accounts")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To respond to user inquiries/offer support to users")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To send administrative information to you")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To fulfil and manage your orders")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To enable user-to-user communications")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To request feedback")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To deliver targeted advertising to you")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To post testimonials")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To protect our Services")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>{t("PrivacyPolicy.To evaluate and improve our Services, products, marketing, and your experience")}:</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>3. {t("PrivacyPolicy.WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?")}</Text>

                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.In Short")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Business Transfers")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.When we use Google Maps Platform APIs")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Affiliates")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Business Partners")}:</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>4. {t("PrivacyPolicy.DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.In Short")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.Google Analytics")} :</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>5. {t("PrivacyPolicy.HOW DO WE HANDLE YOUR SOCIAL LOGINS?")}</Text>
            ...
            return (
                <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ width: '100%', alignSelf: 'center', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>6. {t("PrivacyPolicy.HOW LONG DO WE KEEP YOUR INFORMATION?")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.In Short")}:</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>7. {t("PrivacyPolicy.HOW DO WE KEEP YOUR INFORMATION SAFE?")}</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>8. {t("PrivacyPolicy.DO WE COLLECT INFORMATION FROM MINORS?")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.In Short")}:</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>9. {t("PrivacyPolicy.WHAT ARE YOUR PRIVACY RIGHTS?")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.In Short")}:</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10 }}>{t("PrivacyPolicy.If you have questions or comments about your privacy rights, you may email us at")} <Text style={{ fontSize: 13, color: Color.lightBlack, fontFamily: Mulish.SemiBold, letterSpacing: 0.5 }}>quit@cignix.com</Text>.</Text>
                    </View>
                    <View style={{ width: '100%', marginTop: 0 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>10. {t("PrivacyPolicy.CONTROLS FOR DO-NOT-TRACK FEATURES")}</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 10 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>11. {t("PrivacyPolicy.DO WE MAKE UPDATES TO THIS NOTICE?")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, marginTop: 10 }}>{t("PrivacyPolicy.In Short")}:</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 10 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>12. {t("PrivacyPolicy.HOW CAN YOU CONTACT US ABOUT THIS NOTICE?")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10 }}>{t("PrivacyPolicy.If you have questions or comments about this notice, you may email us at")} <Text style={{ fontSize: 13, color: Color.lightBlack, fontFamily: Mulish.SemiBold, letterSpacing: 0.5 }}>quit@cignix.com</Text> {t("PrivacyPolicy.or contact us by post at")}:</Text>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>Cignix</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>{t("ContactUs.Unit No. 105, First Floor,")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>{t("ContactUs.Iris Tech Park, Sector-48,")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>{t("ContactUs.Gurgaon,")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>{t("ContactUs.Haryana")} 122018,</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>{t("ContactUs.India.")}</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>{t("ContactUs.Phone")}: <Text style={{ fontSize: 13, color: Color.primary, fontFamily: Mulish.SemiBold }}>+91 9873832002</Text></Text>
                        <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5, textDecorationLine: 'underline' }}>quit@cignix.com</Text>
                    </View>
                    <View style={{ width: '100%', marginTop: 10 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, marginTop: 10 }}>13. {t("PrivacyPolicy.HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?")}</Text>
