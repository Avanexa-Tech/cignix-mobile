    ...
    return (
        <ScrollView
            ...
            <View style={styles.container}>
                <Text style={{ textAlign: 'justify', fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.SemiBold, letterSpacing: 0.5, lineHeight: 22 }}>Embark on your journey to quit smoking with Cignix. With our simple resources and dedicated support, you're never alone on this path.</Text>

                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Black, letterSpacing: 0.5 }}>Sign Up</Text>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            ...
                            iconstyle={{ marginTop: 0 }}
                        />
                        <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22, }}>Then, select the <Text style={{ fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>Sign-up </Text>on the next screen.</Text>
                    </View>
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            Icontag={'Entypo'}
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            ...
                            iconstyle={{ marginTop: 0 }}
                        />
                        <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22, }}>Click on the <Text style={{ fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>Get Started </Text>Now option and you have to take a <Text style={{ fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>SIM test</Text>.</Text>
                    </View>
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            Icontag={'Entypo'}
                    ...
                    <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10 }}>Note:</Text>
                ...
                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Black, letterSpacing: 0.5 }}>Log In</Text>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            ...
                            iconstyle={{ marginTop: 0 }}
                        />
                        <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22, }}>Once registered, click on the <Text style={{ fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>Sign-in </Text>tab on the landing page.</Text>
                    </View>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            ...
                            iconstyle={{ marginTop: 0 }}
                        />
                        <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22, }}>Following that, click on the <Text style={{ fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>Password </Text>bar.</Text>
                    </View>
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            Icontag={'Entypo'}
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            ...
                            iconstyle={{ marginTop: 0 }}
                        />
                        <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22, }}>On the landing page, click on the <Text style={{ fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}> Sign-in </Text> option.</Text>
                    </View>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            ...
                            iconstyle={{ marginTop: 0 }}
                        />
                        <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 14, color: Color.cloudyGrey, fontFamily: Mulish.Medium, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22, }}>Select the OTP bar and you will receive an <Text style={{ fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>OTP </Text>via registered email ID or mobile number.</Text>
                    </View>
                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingVertical: 5, }}>
                        <Iconviewcomponent
                            Icontag={'Entypo'}
                ...
                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Black, letterSpacing: 0.5 }}>Customize Your Profile</Text>
                ...
                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Black, letterSpacing: 0.5 }}>Begin Your Program</Text>
                    <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.cloudyGrey, fontFamily: Mulish.Medium, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10 }}>Access your personalized dashboard and start your quit-smoking journey with our expert-guided videos.</Text>
                </View>
