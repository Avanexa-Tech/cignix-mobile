        ...
        <ScrollView
            ...
            <View style={styles.container}>
                ...
                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>Subscription Plan</Text>
                ...
                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, }}>Payment Methods</Text>
                ...
                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, }}>Lifetime Access: One Payment, Endless Benefits</Text>
                ...
                <View style={{ width: '100%', marginTop: 20 }}>
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, }}>Comprehensive Benefits</Text>
                    ...
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, }}>Simple, One-Time Payment</Text>
                    ...
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, }}>Credit and Debit Cards</Text>
                    ...
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, }}>Cancellation, Return & Refund Policies</Text>
                    ...
                    <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, }}>How to Subscribe to Cignix?</Text>
                    ...
                    <View style={{ width: '100%', marginBottom: 10 }}>
                        <Text style={{ textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5 }}>CONTACT US</Text>
                        ...
                        <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>Unit No. 105, First Floor,</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>Iris Tech Park, Sector-48,</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>Gurgaon,</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>Haryana 122018,</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>India.</Text>
                        <Text style={{ textAlign: 'justify', fontSize: 13, color: Color.black, fontFamily: Mulish.Bold, letterSpacing: 0.5, lineHeight: 22, paddingVertical: 5 }}>Phone: <Text style={{ fontSize: 13, color: Color.primary, fontFamily: Mulish.Bold }}>+91 9873832002</Text></Text>
